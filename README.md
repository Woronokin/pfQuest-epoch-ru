...
Когда токены заканчивались в платном тарифе - в ход шли любые более-менее точные модели, вплоть до обновленного DeepSeek v.4. На момент 10.05.2026 переведено все, что было возможно перевести из английской версии аддона.
...
3. Качаем [данный аддон](https://github.com/Woronokin/pfQuest-epoch-ru/releases/tag/pfQuest-epoch-ru-v2.0) и распаковываем в папку с аддонами (epoch-live\Interface\AddOns).
