...
3. Качаем [данный аддон](https://github.com/Woronokin/pfQuest-epoch-ru/releases/tag/pfQuest-epoch-ru-v3.0) и распаковываем в папку с аддонами (epoch-live\Interface\AddOns).
